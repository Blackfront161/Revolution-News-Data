/* World Revolution News 1.7.3 – Briefing, Stimmen und Übersetzungsstatus */
'use strict';
...
(() => {
  ...
  const OVERRIDES = {
    ...
    fr: {
      nav: {
        briefing:'Briefing', start:'Accueil', regions:'Régions', topics:'Thèmes', events:'Événements', audio:'Audio', saved:'Enregistré', zine:'Zine', search:'Recherche', searchPlaceholder:'Rechercher des articles…', settings:'Plus et réglages', sources:'Sources', back:'Retour', article:'Article', language:'Langue', design:'Design', fontSize:'Taille du texte', view:'Affichage', format:'Format', sort:'Tri', info:'Info', contact:'Contact', donate:'Soutenir', storage:'Stockage', status:'État', clear:'Réinitialiser', originalPodcasts:'Podcasts originaux', generatedPodcasts:'Podcasts générés', liveRadio:'Radio en direct', bookmarks:'À lire plus tard', read:'Lu'
      },
      briefing: {
    ...
    pt: {
      nav: {
        briefing:'Resumo', start:'Início', regions:'Regiões', topics:'Temas', events:'Eventos', audio:'Áudio', saved:'Guardados', zine:'Zine', search:'Pesquisar', searchPlaceholder:'Pesquisar artigos…', settings:'Mais e definições', sources:'Fontes', back:'Voltar', article:'Artigo', language:'Idioma', design:'Design', fontSize:'Tamanho do texto', view:'Vista', format:'Formato', sort:'Ordenação', info:'Info', contact:'Contacto', donate:'Doar', storage:'Armazenamento', status:'Estado', clear:'Repor aplicação', originalPodcasts:'Podcasts originais', generatedPodcasts:'Podcasts gerados', liveRadio:'Rádio ao vivo', bookmarks:'Ler depois', read:'Lido'
      },
      briefing: {
    ...
    ru: {
      nav: {
        briefing:'Обзор', start:'Главная', regions:'Регионы', topics:'Темы', events:'События', audio:'Аудио', saved:'Сохранённое', zine:'Зин', search:'Поиск', searchPlaceholder:'Поиск статей…', settings:'Ещё и настройки', sources:'Источники', back:'Назад', article:'Статья', language:'Язык', design:'Оформление', fontSize:'Размер текста', view:'Вид', format:'Формат', sort:'Сортировка', info:'Инфо', contact:'Связаться', donate:'Поддержать', storage:'Хранилище', status:'Статус', clear:'Сбросить приложение', originalPodcasts:'Оригинальные подкасты', generatedPodcasts:'Созданные подкасты', liveRadio:'Радио', bookmarks:'Прочитать позже', read:'Прочитано'
      },
      briefing: {
