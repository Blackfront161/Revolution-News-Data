...
(() => {
  ...
  const EN = {
    ...
    briefing: {
      title: 'My Briefing', today: 'Today', setupTitle: 'Set up your daily briefing',
      ...
      avoidRead: 'Prefer unread developments', create: 'Create my briefing', update: 'Update briefing',
  ...
  const OVERRIDES = {
    de: {
      ...
      briefing: {
        title: 'Mein Briefing', today: 'Heute', setupTitle: 'Tägliches Briefing einrichten',
        ...
        avoidRead: 'Ungelesene Entwicklungen bevorzugen', create: 'Mein Briefing erstellen', update: 'Briefing aktualisieren',
