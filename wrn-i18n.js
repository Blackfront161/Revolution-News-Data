...
(() => {
  ...
  const OVERRIDES = {
    ...
    ru: {
      nav: {
        briefing:'Обзор', stories:'Развитие событий', video:'Видео', start:'Главная', regions:'Регионы', topics:'Темы', events:'События', audio:'Аудио', saved:'Сохранённое', zine:'Зин', search:'Поиск', searchPlaceholder:'Поиск статей…', settings:'Ещё и настройки', sources:'Источники', back:'Назад', article:'Статья', language:'Язык', design:'Оформление', fontSize:'Размер текста', view:'Вид', format:'Формат', sort:'Сортировка', info:'Инфо', contact:'Связаться', donate:'Поддержать', storage:'Хранилище', status:'Статус', clear:'Сбросить приложение', originalPodcasts:'Оригинальные подкасты', generatedPodcasts:'Созданные подкасты', liveRadio:'Радио', bookmarks:'Прочитать позже', read:'Прочитано'
      },
      briefing: {
