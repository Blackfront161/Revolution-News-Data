...
// DER FIX: Lokaler Pfad statt blockierbarem raw.github-Link
const GITHUB_JSON_URL = "./news.json";
...
const uiTexte = {
    en: {
        ...
        radarSummary: "Action Radar (Events)", radarCat: "All Events & Demos",
    ...
    de: {
        ...
        radarSummary: "Aktions-Radar (Termine)", radarCat: "Alle Termine & Demos",
...
// ========================================================
// AUTO-FILL FÜR SPRACHEN (Verhindert JS-Abstürze)
// ========================================================
const fallbackLang = uiTexte['en'];
Object.keys(uiTexte).forEach(lang => {
    Object.keys(fallbackLang).forEach(key => {
        if (uiTexte[lang][key] === undefined) {
            uiTexte[lang][key] = fallbackLang[key];
        }
    });
});
...
// ========================================================
// DER WASSERDICHTE START-PROZESS
// ========================================================
async function initialisiereApp() {
    ...
    // 1. Zuerst sofort Cache laden, falls vorhanden
    try {
    ...
    // 2. Dann die echten Daten holen (Bypass Adblocker mit lokaler URL)
    try {
