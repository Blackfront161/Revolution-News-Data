...
const uiTexte = {
    en: {
        init: "Loading from cache...", error: "Offline Mode.", btnTranslate: "Translate", btnLoading: "Translating...", btnDone: "Translated",
        ...
        radarSummary: "⚠️ Action Radar", radarCat: "All Events & Demos",
    ...
    de: {
        init: "Lade aus Cache...", error: "Offline Modus.", btnTranslate: "Übersetzen", btnLoading: "Übersetze...", btnDone: "Übersetzt",
        ...
        radarSummary: "⚠️ Aktions-Radar", radarCat: "Alle Termine & Demos",
...
const allLangs = ["es", "fr", "it", "pt", "ru", "el", "tr"];
allLangs.forEach(l => { if(!uiTexte[l]) uiTexte[l] = uiTexte['en']; });
...
async function initialisiereApp() {
    ...
    try {
        ...
        if (allNewsData.length === 0) { setTxt('status-container', "Keine Verbindung zum Server möglich."); }
    }
}
...
function renderNextBatch() {
    ...
    if (batch.length === 0) { isRendering = false; return; } 
