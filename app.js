...
// ========================================================
// DER ANTI-ABSTURZ-BLOCK FÜR SPRACHEN (Auto-Fill)
// ========================================================
...
async function initialisiereApp() {
    ...
    // 1. Lade SOFORT aus dem Cache, falls vorhanden
    try {
    ...
    try {
        ...
        if (res.ok) {
            ...
            if(fetchedData && fetchedData.length > 0) {
                ...
                // Aktualisiere das Display nur, wenn wir gerade gestartet sind oder auf "Global" stehen
