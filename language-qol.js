/* World Revolution News 1.7.4 – Sprach- und Bedienungsverbesserungen */
'use strict';

(() => {
  if (window.__wrnLanguageQol174) return;
  window.__wrnLanguageQol174 = true;
  ...
  const patches = {
    es: {
      ...
      catAsia:'Asia', catAustralia:'Australia', catLabor:'Luchas laborales',
    ...
    fr: {
      ...
      catAsia:'Asie', catAustralia:'Australie', catLabor:'Luttes du travail',
    ...
    it: {
      ...
      catAsia:'Asia', catAustralia:'Australia', catLabor:'Lotte del lavoro',
    ...
    pt: {
      ...
      catAsia:'Ásia', catAustralia:'Austrália', catLabor:'Lutas laborais',
    ...
    ru: {
      ...
      catAsia:'Азия', catAustralia:'Австралия', catLabor:'Рабочая борьба',
    ...
    el: {
      ...
      catAsia:'Ασία', catAustralia:'Αυστραλία', catLabor:'Εργατικοί αγώνες',
    ...
    tr: {
      ...
      catAsia:'Asya', catAustralia:'Avustralya', catLabor:'Emek mücadeleleri',
