/* World Revolution News 1.8.3 – read-only runtime self-test */
'use strict';
...
(() => {
    ...
    const TEXTS = Object.freeze({
        en: Object.freeze({
            button:'App self-test', title:'WRN 1.8.3 self-test',
            ...
            version:'App version', build:'Release build', navigation:'Navigation',
        ...
        de: Object.freeze({
            button:'App-Selbsttest', title:'WRN-1.8.3-Selbsttest',
        ...
        es: Object.freeze({
            button:'Autoprueba de la app', title:'Autoprueba WRN 1.8.3',
            ...
            version:'Versión de la app', build:'Compilación de lanzamiento', navigation:'Navegación',
        ...
        fr: Object.freeze({
            button:'Autotest de l’app', title:'Autotest WRN 1.8.3',
            ...
            version:'Version de l’app', build:'Build de publication', navigation:'Navigation',
        ...
        it: Object.freeze({
            button:'Autotest dell’app', title:'Autotest WRN 1.8.3',
            ...
            version:'Versione app', build:'Build di rilascio', navigation:'Navigazione',
        ...
        pt: Object.freeze({
            button:'Autoteste da aplicação', title:'Autoteste WRN 1.8.3',
            ...
            version:'Versão da aplicação', build:'Build de lançamento', navigation:'Navegação',
        ...
        ru: Object.freeze({
            button:'Самопроверка приложения', title:'Самопроверка WRN 1.8.3',
            ...
            version:'Версия приложения', build:'Сборка релиза', navigation:'Навигация',
        ...
        el: Object.freeze({
            button:'Αυτοέλεγχος εφαρμογής', title:'Αυτοέλεγχος WRN 1.8.3',
            ...
            version:'Έκδοση εφαρμογής', build:'Build έκδοσης', navigation:'Πλοήγηση',
        ...
        tr: Object.freeze({
            button:'Uygulama öz testi', title:'WRN 1.8.3 öz testi',
            ...
            version:'Uygulama sürümü', build:'Sürüm derlemesi', navigation:'Gezinme',
    ...
    async function run() {
        ...
        results.push(result(
            text.build,
            build.includes('1.8.3') && build.includes('release-candidate')
                ? 'pass' : 'fail',
            build || text.missing
        ));
    ...
    const install = () => {
        ...
        const target = document.querySelector('.wrn-more-grid, .wrn-more-actions');
