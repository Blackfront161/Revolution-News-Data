/* World Revolution News 1.9.0 – read-only runtime self-test */
'use strict';
...
(() => {
    ...
    const TEXTS = Object.freeze({
        en: Object.freeze({
            button:'App self-test', title:'WRN 1.9.0 release self-test',
        ...
        de: Object.freeze({
            button:'App-Selbsttest', title:'WRN 1.9.0 Release-Test',
        ...
        es: Object.freeze({
            button:'Autoprueba de la app', title:'Prueba de lanzamiento WRN 1.9.0',
        ...
        fr: Object.freeze({
            button:'Autotest de l’app', title:'Autotest de publication WRN 1.9.0',
        ...
        it: Object.freeze({
            button:'Autotest dell’app', title:'Autotest di rilascio WRN 1.9.0',
        ...
        pt: Object.freeze({
            button:'Autoteste da aplicação', title:'Autoteste de lançamento WRN 1.9.0',
        ...
        ru: Object.freeze({
            button:'Самопроверка приложения', title:'Самопроверка релиза WRN 1.9.0',
        ...
        el: Object.freeze({
            button:'Αυτοέλεγχος εφαρμογής', title:'Αυτοέλεγχος έκδοσης WRN 1.9.0',
        ...
        tr: Object.freeze({
            button:'Uygulama öz testi', title:'WRN 1.9.0 sürüm öz testi',
