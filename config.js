...
/* 1.7.0 – Startbild zuerst, App erst nach geladenen Inhalten einblenden */
(() => {
    if (window.__wrnStartScreen170) return;
    window.__wrnStartScreen170 = true;

    const html = document.documentElement;
    html.classList.add('wrn-booting');

    const earlyStyle = document.createElement('style');
    earlyStyle.id = 'wrn-start-screen-style-170';
    earlyStyle.textContent = `
        ...
        #wrn-start-screen {
            ...
            background:
                ...
                url('./app-background.webp?v=170') center top / cover no-repeat,
                #050508;
            opacity: 1;
        ...
        .wrn-start-logo {
            ...
            animation: wrnEarlyLogo170 680ms cubic-bezier(.2,.82,.3,1.15) 240ms forwards;
        }
        ...
        .wrn-start-title {
            ...
            animation: wrnEarlyText170 480ms ease-out 610ms forwards;
        }
        ...
        .wrn-start-loader {
            ...
            opacity: 0;
            animation: wrnEarlyText170 380ms ease-out 760ms forwards;
        }
        ...
        .wrn-start-loader::after {
            ...
            animation: wrnEarlyLoad170 1050ms ease-in-out infinite alternate;
        }

        @keyframes wrnEarlyLogo170 {
            from { opacity: 0; transform: scale(.74) rotate(-4deg); }
            to { opacity: 1; transform: scale(1) rotate(0); }
        }

        @keyframes wrnEarlyText170 {
            from { opacity: 0; transform: translateY(10px); }
            to { opacity: 1; transform: translateY(0); }
        }

        @keyframes wrnEarlyLoad170 {
...
window.WRN_CONFIG = Object.freeze({
    ...
    version: '1.7.0',
    build: '2026.07.18-personal-daily-briefing',
    releasedAt: '2026-07-18T15:40:00Z',
    ...
    style.textContent = `
        ...
        body {
            ...
            background-image:
                ...
                url('./app-background.webp?v=170') !important;
...
(() => {
    if (window.__wrnInterfaceLoader170) return;
    window.__wrnInterfaceLoader170 = true;
    ...
    const loadInterface = async () => {
        addStyle('./release-1.5-nav.css?v=170', 'navigation-170');
        addStyle('./briefing.css?v=170', 'briefing-170');

        try {
            await loadScript('./wrn-i18n.js?v=170', 'i18n-170');
            await loadScript('./briefing.js?v=170', 'briefing-170');
            await loadScript('./release-1.5-nav.js?v=170', 'navigation-170');
        } catch (error) {
