...
extra_count = len(re.findall(r"\bextraTerm\(", lexicon)) - 1
assert 75 <= base_count + extra_count <= 100, (base_count, extra_count)
...
for token in (
    ...
    "versionCode", "jarsigner", "Compare-HashManifest",
