...
def main() -> None:
    ...
    assert 'node tests/test_block3_interface.js' in workflow
    assert 'node tests/test_block3_runtime.js' in workflow
    assert 'python tests/test_block3_assets.py' in workflow
