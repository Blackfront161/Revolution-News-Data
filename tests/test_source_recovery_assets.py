...
assert "const VERSION = '184-release-1';" in config
assert "source-recovery-ui-183.js" in config
assert "source-recovery-ui-183.css" in config
assert "wrn-app-v1.8.4-release-2" in worker
assert "wrn-data-v1.8.4-release-2" in worker
assert "source-recovery-ui-183.js" in worker
assert "source-recovery-ui-183.css" in worker
assert 'wrn-app-v1.8.4-release-2' in audio_assets_test
